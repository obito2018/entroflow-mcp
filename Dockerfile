...
ENV PYTHONDONTWRITEBYTECODE=1     PYTHONUNBUFFERED=1     ENTROFLOW_MCP_TRANSPORT=streamable-http     ENTROFLOW_MCP_HOST=0.0.0.0     ENTROFLOW_MCP_PORT=8732     ENTROFLOW_MCP_PATH=/mcp     HOME=/home/entroflow
