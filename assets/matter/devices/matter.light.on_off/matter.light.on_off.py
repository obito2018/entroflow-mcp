...
DEVICE_INFO = {
    "model": "matter.light.on_off",
    "display_name": "Matter On/Off Light",
    "manufacturer": "Matter",
    "category": "light",
    "platform": "matter",
}
...
class MatterOnOffLight:
    ...
    def _power(self) -> Any:
        return self.client.read_device_attribute(self.did, self.client.ON_OFF_CLUSTER_ID, 0)

    def query_status(self) -> str:
        info = self._descriptor()
        power = "on" if bool(self._power()) else "off"
